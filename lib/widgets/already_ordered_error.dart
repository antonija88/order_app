...
class AlreadyOrderedErrorDialog extends StatelessWidget {
  // const ErrorDialog({
  //   Key key,
  //   @required this.sizeH,
  //   @required this.sizeW,
    ...
    return AlertDialog(
      ...
      title: Stack(
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(left: sizeH * 2.5, top: sizeH * 3, bottom: sizeH * 4),
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(right: sizeH * 1.5),
                  child: Text('You have already placed an order', style: TextStyle(
                    color: kDarkGreyTextColor,
                    fontSize: sizeH * 2,
                  ),
                  ),
